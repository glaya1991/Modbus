...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/modbus_project.elf.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/modbus_project.elf.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/modbus_project.elf ${OBJECTFILES} ${LDLIBSOPTIONS} -T../STM32F103T8Ux_FLASH.ld
...
${OBJECTDIR}/_ext/2ac0c52e/startup_stm32f103xb.o: ../startup/startup_stm32f103xb.s
	...
	$(AS) $(ASFLAGS) -g -o ${OBJECTDIR}/_ext/2ac0c52e/startup_stm32f103xb.o ../startup/startup_stm32f103xb.s
